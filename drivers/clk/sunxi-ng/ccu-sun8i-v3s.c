...
static struct ccu_common *sun8i_r11_ccu_clks[] = {
	&pll_cpu_clk.common,
	&pll_audio_base_clk.common,
	&pll_video_clk.common,
	&pll_ve_clk.common,
...
static struct clk_hw_onecell_data sun8i_r11_hw_clks = {
	.hws	= {
		[CLK_PLL_CPU]		= &pll_cpu_clk.common.hw,
		[CLK_PLL_AUDIO_BASE]	= &pll_audio_base_clk.common.hw,
		[CLK_PLL_AUDIO]		= &pll_audio_clk.hw,
...
static struct ccu_reset_map sun8i_r11_ccu_resets[] = {
	[RST_USB_PHY0]		=  { 0x0cc, BIT(0) },
...
static const struct sunxi_ccu_desc sun8i_r11_ccu_desc = {
	.ccu_clks	= sun8i_r11_ccu_clks,
	.num_ccu_clks	= ARRAY_SIZE(sun8i_r11_ccu_clks),

	.hw_clks	= &sun8i_r11_hw_clks,

	.resets		= sun8i_r11_ccu_resets,
	.num_resets	= ARRAY_SIZE(sun8i_r11_ccu_resets),
};
...
static void __init sun8i_r11_ccu_setup(struct device_node *node)
{
	sun8i_v3_v3s_ccu_init(node, &sun8i_r11_ccu_desc);
}
...
CLK_OF_DECLARE(sun8i_r11_ccu, "allwinner,sun8i-r11-ccu",
	       sun8i_r11_ccu_setup);